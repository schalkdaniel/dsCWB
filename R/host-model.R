...
#' It collects all base learner and also the connections
#' to the sites.
#'
#' @export
HostModel = R6Class("HostModel",
  public = list(
    ...
    #' @param connections (`list(DSOpal::OpalConnection)`)\cr
    #'   Connections to the DataSHIELD servers generated by `DSI::newDSLoginBuilder()`.
    ...
    update = function(blname, par) {
      checmate::assertCharacter(blname, len = 1L, any.missing = FALSE)
